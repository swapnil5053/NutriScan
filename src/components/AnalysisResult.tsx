               ...
               {(hasInferred || result.confidence === 'Low') && (
                  <div className="mt-16 bg-[var(--surface-bg)] p-8 rounded-xl border border-[var(--border-subtle)] relative">
                      ...
                      <p className="text-[1.125rem] text-[var(--text-secondary)] leading-relaxed">
                        {result.confidence === 'Low' ? 'The nutritional analysis operates with lower certainty for this image. Portions and unseen ingredients may vary significantly.' : 'The nutritional analysis operates within expected parameters.'}
